...
class StorageManagerTests(unittest.TestCase):
    ...
    def test_model_manager_exposes_profile_asset_lifecycle(self) -> None:
        ...
        self.assertIn("hybrid-h18-ct-input-scale-lifecycle", registry)
        self.assertIn("hybrid-h19-ct-combined-lifecycle", registry)
        self.assertIn("hybrid-h20-ct-convert-diag", registry)
        self.assertIn("hybrid-h20-modelopt-convert-diag", registry)
        ...
        self.assertIn("vllm-orcarouter-v029-h18-ct-input-scale-lifecycle:v1", storage_assets)
        self.assertIn("vllm-orcarouter-v029-h19-ct-combined-lifecycle:v1", storage_assets)
        self.assertIn("vllm-orcarouter-v029-h20-ct-convert-diag:v1", storage_assets)
        self.assertIn("vllm-orcarouter-v029-h20-modelopt-convert-diag:v1", storage_assets)
        self.assertIn("H14-H16 controls completed; disposable when no container references it", storage_assets)
        self.assertIn("H17 CT post-load weight_scale_2 lifecycle control completed", storage_assets)
        self.assertIn("H18 CT post-load input_scale lifecycle control completed", storage_assets)
        self.assertIn("H19 combined CT post-load lifecycle control completed", storage_assets)
        self.assertIn("Current H20 CT NVFP4 conversion diagnostic", storage_assets)
        self.assertIn("Current H20 ModelOpt NVFP4 conversion diagnostic", storage_assets)
