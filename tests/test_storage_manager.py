...
class StorageManagerTests(unittest.TestCase):
    ...
    def test_model_manager_exposes_profile_asset_lifecycle(self) -> None:
        ...
        self.assertIn('H14/H15 determinism FAIL; retained as the H16 single-sequence runtime-control image', (ROOT / "scripts" / "storage" / "assets.sh").read_text(encoding="utf-8"))
